...
function draw(){
    ...
    if(drawn_sketch == sketch){
        answer_holder = "set";
        score = score + 1;
        console.log("sketch got matched")
    }
...
function updateCanvas(){
    ...
    document.getElementById("drawingToDo").innerHTML = "Sketch To Be Drawn: " + sketch;
}

function checksketch(){
    time_counter = time_counter + 1;
    document.getElementById("timer").innerHTML = "Timer: " + time_counter;
    if(time_counter > 2001){
        time_counter = 1;
...
function gotResults(error,Results){
    if(error){
        ...
        document.getElementById("sketch").innerHTML = drawn_sketch;
        document.getElementById("confi").innerHTML = Results[0].confidence;
    }
}